            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  className="flex min-h-14 w-full items-center justify-between gap-4 rounded-[4px] py-4 text-left [touch-action:manipulation] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)]"
                >
